    ...
    try:
        ...
        FROM (
            SELECT
                $1:Code::VARCHAR,
                $1:Name::VARCHAR,
                $1:ProductGroupCode::VARCHAR,
                $1:ProductGroupName::VARCHAR,
                $1:Active::BOOLEAN,
                $1:Tag::VARCHAR,
                $1:UnitPrice::NUMBER(38,2),
                $1:EAN::VARCHAR,
                $1:Note::VARCHAR,
                $1:ImageUrl::VARCHAR,
                $1:MasterProduct::VARCHAR,
                $1:Packaging::VARIANT,
                $1:Hash_key::VARCHAR,
                METADATA$FILENAME,
                METADATA$FILE_ROW_NUMBER,
...
def lambda_handler(event, context):
    ...
    try:
        ...
        table_name = "REPSLY_PRODUCTS"
        stage_name = "AWS_S3_STAGE_BRONZE"
        subfolder_path = "repsly/Products/"
