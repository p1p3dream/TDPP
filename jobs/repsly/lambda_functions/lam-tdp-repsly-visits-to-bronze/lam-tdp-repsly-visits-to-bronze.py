    ...
    try:
        ...
        FROM (
            SELECT
                ...
                $1:ExplicitCheckIn::BOOLEAN,
                $1:DateAndTimeStart::VARCHAR,
                $1:DateAndTimeEnd::VARCHAR,
                $1:ClientCode::VARCHAR,
                $1:ClientName::VARCHAR,
                ...
                $1:Country::VARCHAR,
                $1:Territory::VARCHAR,
                $1:LatitudeStart::FLOAT,
                $1:LongitudeStart::FLOAT,
                $1:LatitudeEnd::FLOAT,
                $1:LongitudeEnd::FLOAT,
                $1:PrecisionStart::NUMBER,
                $1:PrecisionEnd::NUMBER,
                $1:VisitStatusBySchedule::NUMBER,
                $1:VisitEnded::BOOLEAN,
                $1:Hash_key::VARCHAR,
                METADATA$FILENAME,
                METADATA$FILE_ROW_NUMBER,
                METADATA$FILE_CONTENT_KEY,
        ...
        for row in result:
            if row and len(row) >= 6:
                ...
                # Only log real errors (different from 0)
...
def lambda_handler(event, context):
    ...
    try:
        ...
        table_name = "REPSLY_VISITS"
        stage_name = "AWS_S3_STAGE_BRONZE"
        subfolder_path = "repsly/Visits/"
